...
INSERT INTO user (`userId`,`userName`,`firstName`,`lastName`,`email`,`role`,`password`) VALUES ('aa7e74f5-d1be-4d1b-9536-84c92a5d7518','amoo','Aladah ','Moore','moor0667@algonquinlive.com',NULL,'amoo');
INSERT INTO user (`userId`,`userName`,`firstName`,`lastName`,`email`,`role`,`password`) VALUES ('ceb5f8eb-a350-42fc-86fb-d7e04ecbb748','kga','Kaitlin','Gatineau','gati0010@algonquinlive.com',NULL,'kga');
INSERT INTO user (`userId`,`userName`,`firstName`,`lastName`,`email`,`role`,`password`) VALUES ('eba675ab-2a37-43de-9223-b78422be9723','hjung','Hyosung','Jung','jung0067@algonquinlive.com',NULL,'hjung');
